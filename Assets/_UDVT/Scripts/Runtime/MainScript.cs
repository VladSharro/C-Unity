...
public class MainScript : MonoBehaviour
{
    ...
    public async void LoadAndVisualize()
    {
        ...
        string filePath = fileLoadingManager.StartPicker(); //just change if it wrong
        ...
        vis = Vis.GetSpecificVisType(VisType.Bar); //VisType.Scatterplot
        vis.AppendData(dataSet);
        //vis.visAA(dataSet);
        //vis.Recalculate(dataSet);
        //vis.SturgesFormulaBinning(dataSet);
